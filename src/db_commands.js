...
export async function buyItem(user_id, item_name) {
	...
	if (item_data.type == "food") {
		...
		await updateUser(user_id, {food: food, num_coins: user_data.num_coins - item_data.cost})
		...
		await updateUser(user_id, {toys: toys, num_coins: user_data.num_coins - item_data.cost})
	}
		...
		await updateUser(user_id, {clothes: clothes, num_coins: user_data.num_coins - item_data.cost})
	}
	else {
